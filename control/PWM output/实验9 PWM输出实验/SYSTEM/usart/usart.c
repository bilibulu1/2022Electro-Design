...
#include "stdio.h"
#include "led.h"
static u8 Cxl=0,Cxh=0,Cyl=0,Cyh=0;
u16 Cx=0,Cy=0;
////////////////////////////////////////////////////////////////////////////////// 	 
...
void USART2_IRQHandler(void)			 
{
		...
		if( USART_GetITStatus(USART2,USART_IT_RXNE)!=RESET)  	   //接收中断  
		{
				...
				if(RxState==0&&com_data==255)  //0x2c帧头
				{
					RxState=1;
					LED0=!LED0;
				...
				else if(RxState==1&&com_data==254)  //0x12帧头
				{
					RxState=2;
					RxBuffer1[RxCounter1++]=com_data;

				}
				else if(RxState==2)  //0x12帧头
				{
					RxBuffer1[RxCounter1++]=com_data;
					RxState=3;
			    }
				...
				else if(RxState==3)
				{
					...
					if(RxCounter1==8)       //RxBuffer1接受满了,接收数据结束
					{
						RxState=4;
						RxFlag1=1;
						Cxh=RxBuffer1[RxCounter1-5];
						Cxl=RxBuffer1[RxCounter1-4];
						Cyh=RxBuffer1[RxCounter1-3];
						Cyl=RxBuffer1[RxCounter1-2];
                        Cx=256*Cxh+Cxl;
                        Cy=256*Cyh+Cyl;  
